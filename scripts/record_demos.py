...
def run_simulation_loop(
    ...
    teleoperation_callbacks = {
        ...
        "SUCCESS": success_recording_instance,
        "START_STOP" : start_stop_recording_instance
    }
    ...
    with contextlib.suppress(KeyboardInterrupt) and torch.inference_mode():
        while simulation_app.is_running():
            ...
            success_step_count, success_reset_needed = process_success_condition(env, success_term, success_step_count, manual_success)
