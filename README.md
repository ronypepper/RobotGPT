...
4. Define a new openpi integration file in "RobotGPT/openpi/robotgpt/robot_configs/", which implements:
...
5. Register the new Training Configs from step 4. in "RobotGPT/openpi/robotgpt/configurations.py" by extending the *all_cfgs* object with the new configs list.
6. Register the *get_data_dimensions_<ROBOT_NAME>* and *extract_hdf5_frame_<ROBOT_NAME>* functions in "RobotGPT/openpi/robotgpt/hdf5_dataset_interfaces.py" in the *HDF5_DATASET_INTERFACE_FCTS* object under a name for the new robot type.
