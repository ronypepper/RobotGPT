...
class PinkInverseKinematicsArmOnlyAction(ActionTerm):
    ...
    cfg: PinkInverseKinematicsArmOnlyActionCfg
    """Configuration for the Pink Inverse Kinematics action term."""

    _asset: Articulation
    """The articulation asset to which the action term is applied."""

    def __init__(self, cfg: PinkInverseKinematicsArmOnlyActionCfg, env: ManagerBasedEnv):
    ...
    def apply_actions(self) -> None:
        ...
        if self.hand_joint_dim > 0:
            ...
            self._processed_actions = ik_joint_positions
...
@configclass
class PinkInverseKinematicsArmOnlyActionCfg(ActionTermCfg):
    ...
    class_type: type[ActionTerm] = PinkInverseKinematicsArmOnlyAction
