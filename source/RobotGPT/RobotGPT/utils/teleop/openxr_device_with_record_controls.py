...
"""OpenXR-powered device for teleoperation and interaction with additional capabilities to signal reset, success and 
pause to the (modified) record_demo.py script."""
