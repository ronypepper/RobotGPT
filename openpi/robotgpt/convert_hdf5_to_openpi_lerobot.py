"""
Script for converting a hdf5 dataset (generated by RobotGPT's modified version of Isaac Lab's record_demo.py script) to
the LeRobot format expected by openpi.
